...
![](assets/d8-2-swe-lab2hel-bgi-draft2_image3.jpg)
...
<td>Regional/<a href="https://www.lantmateriet.se/sv/geodata/vara-produkter/produktlista/markhojdmodell-nedladdning/"><span class="underline">National Geoportal</span></a></td>
...
<td><a href="https://vattenatlas.se/"><span class="underline">VattenAtlas</span></a></td>
<td>Input for pluvial flood modelling and hazard mapping</td>
<td>ERA5 <a href="https://cds.climate.copernicus.eu/datasets/sis-european-risk-extreme-precipitation-indicators?tab=overview"><span class="underline">extreme precipitation indicators</span></a></td>
</tr>
<tr class="even">
<td>Extreme and maximum flow data</td>
<td><a href="https://gisapp.msb.se/Apps/oversvamningsportal/hemta-data.html"><span class="underline">MSB</span></a> (Swedish Civil Contingencies Agency); <a href="https://vattenatlas.se/"><span class="underline">VattenAtlas</span></a></td>
<td>Peak river flow estimation under design scenarios</td>
<td>Copernicus Climate Dat store <a href="https://cds.climate.copernicus.eu/datasets/sis-hydrology-variables-derived-projections?tab=download"><span class="underline">“Hydrology-related climate impact indicators from 1970 to 2100 derived from bias adjusted European climate projections”</span></a></td>
</tr>
<tr class="odd">
<td>Historical wetlands</td>
<td><a href="https://vattenatlas.se/"><span class="underline">VattenAtlas</span></a></td>
<td>Identify potential restoration areas and historical flood retention zones</td>
<td>Copernicus <a href="https://land.copernicus.eu/en/products/global-dynamic-land-cover/land-cover-2020-raster-10-m-global-annual"><span class="underline">Land Cover 2020 (raster 10 m), global, annual - version 1</span></a>, includes wetlands delineation</td>
</tr>
<tr class="even">
...
<td><a href="https://land.copernicus.eu/en/products/eu-hydro"><span class="underline">EU-Hydro River Network Database 2006-2012 (vector), Europe</span></a></td>
</tr>
<tr class="even">
...
<td>Copernicus High Resolution Layer: <a href="https://land.copernicus.eu/en/products/high-resolution-layer-forests-and-tree-cover"><span class="underline">High Resolution Layer Tree Cover and Forests</span></a><br />
Copernicus <a href="https://land.copernicus.eu/en/products/global-dynamic-land-cover/land-cover-2020-raster-10-m-global-annual"><span class="underline">Land Cover 2020 (raster 10 m), global, annual - version 1</span></a>, includes wetlands delineation</td>
</tr>
<tr class="even">
<td>Natura 2000 sites</td>
<td><a href="https://ext-webbgis.lansstyrelsen.se/naturvardesoversikt/"><span class="underline">National Geoportal</span></a></td>
<td>Identify legally protected ecological zones</td>
<td>EEA Natura 2000 Database (<a href="https://www.eea.europa.eu/data-and-maps/data/natura-14/natura-2000-spatial-data"><span class="underline">vector, Europe-wide</span></a>)</td>
</tr>
</tbody>
</table>
...
![](assets/d8-2-swe-lab2hel-bgi-draft2_image9.png)

![Immagine che contiene Aerofotogrammetria, Vista aerea, mappa, aereo Il contenuto generato dall'IA potrebbe non essere corretto.](assets/d8-2-swe-lab2hel-bgi-draft2_image10.png)
...
| [<span class="underline">ArcGIS Pro</span>](https://www.esri.com/en-us/arcgis/products/arcgis-pro/overview) | Proprietary | GIS platform for overlaying ecological and flood layers, digitising connectivity corridors, and producing BGI priority maps                                                                                                                                   |
...
| [<span class="underline">Scalgo Live</span>](https://scalgo.com/)                                           | Proprietary | Visualises surface water accumulation, identifies depressions and overland flow paths under heavy rainfall or high flow scenarios. Generates base flood hazard layers (e.g. 100-year rainfall, low points, extreme flows) used to delineate flood-prone areas |
| [<span class="underline">SaferPlaces</span>](https://saferplaces.co/)                                       | Proprietary | Visualises surface water accumulation, identifies depressions and overland flow paths under heavy rainfall or high flow scenarios. Generates base flood hazard layers (e.g. 100-year rainfall, low points, extreme flows) used to delineate flood-prone areas |
| [<span class="underline">TauDEM</span>](https://hydrology.usu.edu/taudem/taudem5/)                          | Open        | Topographic analysis for flow paths and watershed delineation                                                                                                                                                                                                 |
| [<span class="underline">HEC-RAS</span>](https://www.hec.usace.army.mil/software/hec-ras/download.aspx)     | Open        | Hydraulic modelling for flood scenarios, estimation of flood extent and water depth                                                                                                                                                                           |
...
![Immagine che contiene mappa, testo, atlante Il contenuto generato dall'IA potrebbe non essere corretto.](assets/d8-2-swe-lab2hel-bgi-draft2_image11.jpg)
...
![](assets/d8-2-swe-lab2hel-bgi-draft2_image12.png)

Figure 5 – example of depression detection via raster-based analysis of DTM (courtesy of [<span class="underline">SaferPlaces</span>](https://saferplaces.co/))
...
![Immagine che contiene testo, mappa, atlante, schermata Il contenuto generato dall'IA potrebbe non essere corretto.](assets/d8-2-swe-lab2hel-bgi-draft2_image13.png)

![Immagine che contiene mappa, testo, atlante Il contenuto generato dall'IA potrebbe non essere corretto.](assets/d8-2-swe-lab2hel-bgi-draft2_image14.jpg)
...
![](assets/d8-2-swe-lab2hel-bgi-draft2_image15.png)

![Immagine che contiene mappa, testo Il contenuto generato dall'IA potrebbe non essere corretto.](assets/d8-2-swe-lab2hel-bgi-draft2_image16.png)

Figure 7 - Example of 2D flood model of a flood volume upstream of an urban area (courtesy of [<span class="underline">SaferPlaces</span>](https://saferplaces.co/))
...
1.  [<span class="underline">https://www.mdpi.com/2073-4441/12/6</span>](https://www.mdpi.com/2073-4441/12/6)